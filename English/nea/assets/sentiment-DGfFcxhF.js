      ...
      <div class="container">
        ...
        <div class="model-loading-container" id="modelLoadingContainer">
          <div class="model-loading-text">
            ...
            <div class="model-loading-subtitle">Downloading <code>shukitchan2023/robust-sentiment-analysis-ONNX model<code> from Hugging Face. It will be cached for next time you visit this page!</div>
          </div>
        ...
        <div class="input-section">
          <div class="input-wrapper">
            <textarea 
              id="textInput" 
              placeholder="Enter your text here to analyse its sentiment. Try multiple sentences to see detailed analysis..."
              maxlength="10000"
            ></textarea>
